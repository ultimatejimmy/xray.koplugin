...
function Localization:t(key, ...)
    ...
    if not translation or translation == "" then
        ...
        local fallbacks = {
            ...
            menu_fetch_xray = "Fetch X-Ray Data",
            menu_rebuild_xray = "Rebuild X-Ray Data (Clean Fetch)",
            rebuild_confirm_title = "Rebuild X-Ray Data",
            rebuild_confirm_text = "This will discard all cached X-Ray data for this book and fetch fresh data from AI.\n\nContinue?",
            rebuild_confirm_btn = "Rebuild",
            ...
            sort_by = "Sort By",
            sort_frequency = "Frequency of Mentions (Default)",
            sort_appearance = "Order of Appearance",
            ...
            entity_type_historical = "Historical Figure",
            entity_type_term = "Term",
            no_linked_entries = "No linked entries found",
            linked_with_title = "Linked with: %s",
            linked_none = "No linked entries found for '%s'.",
            ...
            menu_set_keys_device = "Set API Key from Phone/PC",
            menu_setup_cloud = "Cloud Relay (Recommended — works anywhere)",
            menu_setup_local = "Local Wi-Fi (Offline LAN)",
            cloud_setup_title = "Connect via Phone/PC",
            local_setup_title = "Connect via Local Wi-Fi",
            ...
            error_busy_title = "Request in Progress",
            error_busy_desc = "Another AI request is already running in the background. Please wait for it to finish or try again shortly.",
            error_busy_author = "Another AI request is already running.\n\nCancel it and fetch author info instead?",
            ...
            menu_manage_series = "Manage Series…",
            manage_series_series_name = "Series Name",
            manage_series_unnamed = "(Tap to name series)",
            manage_series_add_book = "Add Book…",
            manage_series_choose_book = "Choose Book to Add",
            manage_series_current_book = "(Current Book)",
            manage_series_edit_entry = "Edit Volume # & Title",
            manage_series_remove_entry = "Remove from Series",
            manage_series_volume_label = "Volume #",
            manage_series_title_label = "Title",
            manage_series_edit_title = "Edit Book Title",
            manage_series_saved = "Series saved.",
            manage_series_name_required = "Please specify a series name before saving.",
            manage_series_already_added = "This book is already in the series roster.",
            manage_series_pick_index = "Select Volume #",
            manage_series_custom_index = "Custom number…",
            manage_series_enter_index = "Enter Volume Number",
            picker_list_view = "List",
            picker_cover_view = "Covers",
            picker_items_count = "%d folders, %d books",
            picker_no_books_found = "No ebook files found in this folder.",
            menu_clear_series_cache = "Clear Series Cache",
            series_cache_cleared = "Series cache cleared for '%s'.",
            no_series_to_clear = "No series detected for this book.",
            later = "Later",
            ...
            welcome_tag = "WELCOME TO X-RAY",
            welcome_select_provider = "Select AI Provider",
            welcome_headline = "Set Up AI Provider",
            welcome_desc = "To get started, choose how you would like to connect your API key:",
            welcome_opt_phone_title = "Set from Phone/PC (Recommended)",
            welcome_opt_phone_desc = "Scan a QR code to enter your key online via Cloud Relay or local Wi-Fi.",
            welcome_opt_ereader_title = "Enter Key on E-Reader",
            welcome_opt_ereader_desc = "Type or paste your API key directly using the on-screen keyboard.",
            welcome_opt_file_title = "Import via Text File (xray_key.txt) or Config",
            welcome_opt_file_desc = "Auto-import keys from an xray_key.txt file, or view wiki setup instructions.",
            welcome_opt_all_title = "Open All Provider Settings",
            welcome_opt_all_desc = "Configure custom endpoints, OpenAI, DeepSeek, Claude, or OpenRouter.",
            welcome_action_continue = "Continue",
            welcome_action_ask_later = "Ask Later",
            ...
            menu_clear_all_keys = "Clear All API Keys...",
            confirm_clear_all_keys = "Are you sure you want to clear all configured API keys and custom endpoints?\n\nThis will remove all saved keys from this device.",
            btn_clear_keys = "Clear All Keys",
            keys_cleared = "All API keys cleared.",
            menu_clear_single_key = "Clear %s Key...",
